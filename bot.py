...
print("[BOT] Kết Nối Thành Công => Xin Chào  Cậu Chủ TRAN ANH TUAN")
...
╠➤ /doneta - Ủng Hộ AD
╚======[Copyright_By@giangalus======╝</blockquote>"""

    keyboard = types.InlineKeyboardMarkup(row_width=2)  
    keyboard.add(
        types.InlineKeyboardButton("👤 Admin", url="https://t.me/@giangalus"),
        types.InlineKeyboardButton("Kênh Code", url="https://t.me/share_code_ngon")
    )
...
def welcome_new_member(message):
    for new_member in message.new_chat_members:
        ...
        welcome_text = f'''
<blockquote>🎉 Chào Mừng {user_info} Đến Với Nhóm! u🎉
Hy Vọng Bạn Sẽ Có Thời Gian Vui Vẻ ở Đây!
